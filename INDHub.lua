if not game:IsLoaded() then game.Loaded:Wait() end
    if game.PlaceId == 120570155878200 then
        loadstring(game:HttpGet("https://raw.githubusercontent.com/Enzo-YTscript/scrp/main/120570155878200.lua"))() --Broom Training
    ...
    elseif game.PlaceId == 18629053284 then
        loadstring(game:HttpGet("https://raw.githubusercontent.com/Enzo-YTscript/scrp/main/18629053284.lua"))() -- survival odyssey
    elseif game.PlaceId == 18629058177 then
        loadstring(game:HttpGet("https://raw.githubusercontent.com/Enzo-YTscript/scrp/main/18629058177.lua"))()	-- void
    elseif game.PlaceId == 92039548740735  then
        loadstring(game:HttpGet("https://raw.githubusercontent.com/Enzo-YTscript/scrp/main/92039548740735.lua"))() -- underoworld
    elseif game.PlaceId == 93787311916283  then
